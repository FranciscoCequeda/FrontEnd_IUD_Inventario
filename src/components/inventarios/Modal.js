                    ...
                    <div className="modal-body">
                        <form onSubmit={guardarElement}>
                            <div className="mb-3">
                                ...
                                <input type="text" className="form-control" id="recipient-name" onChange={changeInput} value={element.serial} name={"serial"} />
                            </div>
                            <div className="mb-3">
                                <label htmlFor="recipient-email" className="col-form-label">Email:</label>
                                <input type="email" className="form-control" id="recipient-email" onChange={changeInput} value={element.precio} name={"precio"} />
                            </div>
                            <div className="modal-footer">
                                <button type="button" className="btn btn-secondary" data-bs-dismiss="modal" onClick={reset}>Cerrar</button>
                                <button type="submit" className="btn btn-success" disabled={element.serial.length < 1}>Guardar</button>
                            </div>
